...
if (isset($_REQUEST['PROYECTID'])) {
    ...
    $sql_proyect_img    = mysqli_query($con, "SELECT count(*) AS numrows FROM tif_proyect where id_proyect='" . $proyect_id . "' and status_imagen=1 ");
...
?>
    ...
    <div class="row">
        ...
        <?php while ($row = mysqli_fetch_array($query)) {
            ...
            $formato_img        = $row['formato'];
            $folder             = $row['folder_imagen'];
            $url_imagen         = "files/" . $folder . "/" . $imagen;
