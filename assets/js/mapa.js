...
//mostrarRaster("assets/img/tiff/universidad.tif");
//mostrarRaster("corte.tif");
mostrarInfoShapefile("assets/img/tiff/caminos_1700_zonaB1.zip");
mostrarRaster("assets/img/tiff/odm_orthophoto.tif");
//mostrarRaster("assets/img/tiff/01.tif");
//mostrarRaster("rios_1700_zonaB1.zip");

var i = 1;
var url ="assets/img/tiff/poly1.json";
...
function insertarUbicacionShapefile(valores){
    var selector = document.getElementById('ubicacion');
    var option = document.createElement('option');
    var latitudprom = valores[1];
    var longitudprom = valores[0];
    option.value = latitudprom+ ","+longitudprom;
    option.innerHTML = "ubic_"+i;
    i++;
    selector.appendChild(option);
...
function mostrarInfoShapefile(url_zip_shapefile)
{
    var elem = [];
    var ultLayer = {};
    var shpfile = new L.Shapefile(url_zip_shapefile, {
        onEachFeature: function (feature, layer)
        {
            if (feature.properties)
            {
                ...
                Object.assign(ultLayer, layer);
                //elem = Object.keys(ultLayer);
            }

        }

    });
    console.log('shapfile:', shpfile);
    console.log(ultLayer);
    //console.log(elem);
    //var objeto = Object.keys(ultLayer);
    //console.log(objeto);
    shpfile.addTo(map);
    shpfile.once("data:loaded", function ()
    {
        console.log("finished loaded shapefile");
        ubicacion = ultLayer["feature"]["geometry"]["bbox"];
        insertarUbicacionShapefile(ubicacion);
    });
}
