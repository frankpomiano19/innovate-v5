    ...
    i(u, [], function() {
        var e = function(e) {
            ...
            l = function() {
                var e = 0;
                return function(t) {
                    var n = (new Date).getTime().toString(8),
                        i;
                    for (i = 0; 5 > i; i++) n += Math.floor(6 * Math.random()).toString(8);
                    return n + (e++).toString(8)//id para cada imagen
                }
            }(),
            d = function(e) {
...
(function(e, t, n) {
    ...
    o.addFileFilter("mime_types", function(e, t, n) {
        e.length && !e.regexp.test(t.name) ? (this.trigger("Error", {
            ...
            message: o.translate("Actualmente no esta permitido este tipo de archivo. \nSeleccione otro."),
            file: t
        }), n(!1)) : n(!0)
        ...
        e = o.parseSize(e), t.size !== r && e && t.size > e ? (this.trigger("Error", {
            ...
            message: o.translate("Error con el tamaño del archivo, es muy pesado"),
            file: t
        }), n(!1)) : n(!0)
            ...
            while (r--)
                if (t.name === this.files[r].name && t.size === this.files[r].size) {
                    this.trigger("Error", {
                        ...
                        message: o.translate("Error de archivo duplicado"),
                        file: t
                    }), n(!1);
                    return
                }
