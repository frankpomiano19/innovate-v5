...
if (isset($_REQUEST['idProyecto'])) {
    ...
    $targetDir             = "../../../files/" . $ramdon . "/imagenestif";
    $finalDir              = "../../../files/" . $ramdon . "/imagenestif";
    ...
    if ($chunk == ($chunks - 1)) {
        ...
        $insert_datos = mysqli_query($con, "insert INTO tif_proyect VALUES (
						NULL,'$id_proyecto','$fileNameN','$tamano','$tipo_dato','$id_proyecto','$targetDir','$fecha_actual','1')");
        ################## fin de la sentencia #############################################################
        echo $chunk . "<br>";
        echo $chunks - 1;
    }
