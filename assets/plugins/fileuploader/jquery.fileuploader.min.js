...
! function($) {
                ...
                f = {
                    ...
                    thumbnails: {
                        ...
                        renderThumbnail: function(d, e, t) {
                            var u = d.html.find(".fileuploader-item-image"),
                    ...
                    editor: {
                                    ...
                                    s.popup.zoomer = {
                                        ...
                                        mousemove: function(e) {
                                            var t = s.popup.zoomer,
                                                ...
                                                n = i - t.pointData.xTarget,
                                                a = r - t.pointData.yTarget;
                                        ...
                                        getImageSize: function() {
                                            return {
                                                width: d.prop("naturalWidth"),
                                                height: d.prop("naturalHeight")
                                            }
                                        },
                        ...
                        save: function(w, b, x, _, y) {
                            var e = w.popup && w.popup.html && $("html").find(w.popup.html).length,
                                t = new Image,
                                i = function() {
                                    if (w.reader.node) {
                    ...
                    sorter: {
                        ...
                        mousedown: function(e) {
                            var t = e.originalEvent.touches && e.originalEvent.touches[0] ? "touchstart" : "mousedown",
                                o = $(e.target),
                                i = o.closest(n.thumbnails._selectors.item),
                                r = f.files.find(i),
                                a = {
                        ...
                        mousemove: function(e) {
                            ...
                            if (c) {
                                ...
                                var g = r.index(i.html),
                                    v = r.index(c) < g ? "before" : "after";
                        ...
                        send: function(a, e) {
                            if (a.upload) {
                                ...
                                if (p.addClass("fileuploader-is-uploading"), a.upload.$ajax && a.upload.$ajax.abort(), delete a.upload.$ajax, delete a.upload.send, a.upload.status = "loading", a.html && (n.thumbnails._selectors.start && a.html.find(n.thumbnails._selectors.start).remove(), d()), a.upload.data)
                                    for (var h in a.upload.data) a.upload.formData.append(h, a.upload.data[h]);
                    ...
                    files: {
                            ...
                            if (f.isFileReaderSupported() && !d.data.readerSkip) {
                                ...
                                if ("astext" == d.format) a.onload = function(e) {
                                    ...
                                    a.onload = function(e) {
                                        var s = new Image,
                                            t = function() {
                                                d.data && d.data.readerCrossOrigin && s.setAttribute("crossOrigin", d.data.readerCrossOrigin), s.src = e.target.result + (!d.data.readerForce && !i || h || c || -1 != e.target.result.indexOf("data:image") ? "" : (-1 == e.target.result.indexOf("?") ? "?" : "&") + "d=" + Date.now()), s.onload = function() {
                                                    ...
                                                    d.reader.node = s, d.reader.src = s.src, d.reader.width = s.width, d.reader.height = s.height, d.reader.ratio = f._assets.pxToRatio(d.reader.width, d.reader.height), g && u.revokeObjectURL(g), m(), c && (d.reader = {
                                                        read: d.reader.read
                                                    })
                                                }, s.onerror = function() {
                                                    m(), d.reader = {
                                        ...
                                        target: {
                                            result: g = u.createObjectURL(d.file)
                                        }
                                    ...
                                    var g, v = document.createElement(d.format),
                                        w = v.canPlayType(d.type);
                        ...
                        list: function(r, a, e, t) {
                            ...
                            return !n.sorter || e || t && "ignoreSorter" == t || f.sorter.save(!0), $.each(f._itFl, function(e, t) {
                                ...
                                var o = t;
                                if ((a || r) && (o = (o.choosed ? "0:/" : "") + (a && null !== f.files.getItemAttr(t, a) ? f.files.getItemAttr(t, a) : t["string" == typeof t.file ? "file" : "name"])), r && (o = {
                                        file: o
                        ...
                        getExifOrientation: function(e, p) {
                            ...
                            t.onload = function(e) {
                                ...
                                if (t.byteLength && 65496 == t.getUint16(0, !1))
                                    for (var i = t.byteLength, r = 2; r < i && !(t.getUint16(r + 2, !1) <= 8);) {
    ...
    $.fn.fileuploader.defaults = {
        ...
        captions: {
            ...
            removeConfirmation: "¿Estás seguro que deseas quitar este archivo?",
            errors: {
                filesLimit: "Solo se permiten cargar ${limit} archivos.",
                filesType: "Tipo de archivo no admitido",
                fileSize: "${name} is too large! Please choose a file up to ${fileMaxSize}MB.",
                filesSizeAll: "El archivo que eligiste supera la capacidad permitida ${maxSize} MB.",
