	...
	obj.html(
		'<div class="plupload_wrapper">' +
			'<div class="ui-widget-content plupload_container">' +
				...
				'<tr>' +
					'<td class="plupload_cell plupload_file_name">' + _('Nombre Archivo') + '</td>' +
					'<td class="plupload_cell plupload_file_status">' + _('Estado') + '</td>' +
					'<td class="plupload_cell plupload_file_size">' + _('Tamaño') + '</td>' +
				...
				'<tr>' +
					'<td class="plupload_cell plupload_file_name">' +
						'<div class="plupload_buttons"><!-- Visible -->' +
							...
							'<a class="plupload_button plupload_start">' + _("Subir Archivos") + '</a>&nbsp;' +
							//'<a class="plupload_button plupload_stop plupload_hidden">'+_("Detener Proceso") + '</a>&nbsp;' +
						//'</div>' +
		...
		uploader.bind('Error', function(up, err) {			
			...
			switch (err.code) {
				case plupload.FILE_EXTENSION_ERROR:
					//details = o.sprintf(_("Filess: %s"), err.file.name);
					details = swal("Tipo de archivo no permitido");
					break;
				...
				case plupload.HTTP_ERROR:
					...
					details = swal("Ocurrio un error.");
					//location.reload();uploader_filelist
	...
	*/
	...
	_handleState: function() {
		...
		if (up.total.queued === 0) {
			$('.ui-button-text', this.browse_button).html(_('Agregar Archivos'));
		} else {
			$('.ui-button-text', this.browse_button).html(o.sprintf(_('%d archivos'), up.total.queued));
		}
	...
	_addFiles: function(files) {
		...
		file_html = '<li class="plupload_file ui-state-default plupload_file_loading plupload_delete" id="%id%" style="width:%thumb_width%px;">' +
			...
			'<div class="plupload_file_action">' +
				'<div class="plupload_action_icon  ui-icon-circle-minus"> </div>' +
			'</div>' +
